...
use ShopMagicGoogleSheetsVendor\Google\Client;
...
use ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Uri;
...
class MediaFileUpload
{
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\Google\Client $client, \ShopMagicGoogleSheetsVendor\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = 0)
    {
        $this->client = $client;
    ...
    public function nextChunk($chunk = \false)
    {
        ...
        $request = new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Request('PUT', $resumeUri, $headers, \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Utils::streamFor($chunk));
     ...
     *
     */
    private function makePutRequest(\ShopMagicGoogleSheetsVendor\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return \ShopMagicGoogleSheetsVendor\Google\Http\REST::decodeHttpResponse($response, $this->request);
    }
    /**
    ...
    public function resume($resumeUri)
    {
        ...
        $httpRequest = new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Request('PUT', $this->resumeUri, $headers);
    ...
    private function process()
    {
        ...
        $request = $request->withUri(\ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Uri::withQueryValue($request->getUri(), 'uploadType', $uploadType));
        ...
        $request = $request->withBody(\ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Utils::streamFor($postBody));
        if ($contentType) {
    ...
    private function fetchResumeUri()
    {
        ...
        throw new \ShopMagicGoogleSheetsVendor\Google\Exception($error);
    }
    private function transformToUploadUrl()
    {
        ...
        $uri = \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Uri::fromParts($parts);
