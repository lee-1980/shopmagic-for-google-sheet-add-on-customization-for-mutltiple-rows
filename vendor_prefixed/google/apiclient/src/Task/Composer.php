...
use ShopMagicGoogleSheetsVendor\Composer\Script\Event;
use InvalidArgumentException;
use ShopMagicGoogleSheetsVendor\Symfony\Component\Filesystem\Filesystem;
use ShopMagicGoogleSheetsVendor\Symfony\Component\Finder\Finder;
class Composer
{
    /**
     ...
     */
    public static function cleanup(\ShopMagicGoogleSheetsVendor\Composer\Script\Event $event, \ShopMagicGoogleSheetsVendor\Symfony\Component\Filesystem\Filesystem $filesystem = null)
    {
        ...
        if ($servicesToKeep) {
            ...
            $filesystem = $filesystem ?: new \ShopMagicGoogleSheetsVendor\Symfony\Component\Filesystem\Filesystem();
    ...
    {
        $finder = (new \ShopMagicGoogleSheetsVendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0');
    ...
    private static function getServicesToRemove($serviceDir, array $servicesToKeep)
    {
        ...
        return (new \ShopMagicGoogleSheetsVendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0')->in($serviceDir)->exclude($servicesToKeep);
    }
}
