...
class Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \ShopMagicGoogleSheetsVendor\Google\Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \ShopMagicGoogleSheetsVendor\Google\Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
    /** @return bool */
