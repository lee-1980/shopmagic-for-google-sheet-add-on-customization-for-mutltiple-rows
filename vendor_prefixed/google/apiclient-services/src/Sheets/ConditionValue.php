...
class ConditionValue extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ConditionValue::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_ConditionValue');
