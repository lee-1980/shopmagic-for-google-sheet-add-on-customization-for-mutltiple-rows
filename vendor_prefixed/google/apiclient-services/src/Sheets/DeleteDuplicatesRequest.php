...
class DeleteDuplicatesRequest extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'comparisonColumns';
    protected $comparisonColumnsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DimensionRange::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DeleteDuplicatesRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DeleteDuplicatesRequest');
