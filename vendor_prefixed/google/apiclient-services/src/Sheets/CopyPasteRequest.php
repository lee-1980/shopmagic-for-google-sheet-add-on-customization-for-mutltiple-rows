...
class CopyPasteRequest extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    protected $destinationType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridRange::class;
     ...
     * @param GridRange
     */
    public function setDestination(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridRange $destination)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\CopyPasteRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_CopyPasteRequest');
