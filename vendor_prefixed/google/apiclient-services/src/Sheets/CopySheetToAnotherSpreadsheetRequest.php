...
class CopySheetToAnotherSpreadsheetRequest extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\CopySheetToAnotherSpreadsheetRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_CopySheetToAnotherSpreadsheetRequest');
