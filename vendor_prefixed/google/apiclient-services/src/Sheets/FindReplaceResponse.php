...
class FindReplaceResponse extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\FindReplaceResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_FindReplaceResponse');
