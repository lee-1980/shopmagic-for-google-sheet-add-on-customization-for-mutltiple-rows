...
class SpreadsheetTheme extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $themeColorsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ThemeColorPair::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\SpreadsheetTheme::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_SpreadsheetTheme');
