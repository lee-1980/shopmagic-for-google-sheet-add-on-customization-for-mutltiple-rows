...
class GridProperties extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridProperties::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_GridProperties');
