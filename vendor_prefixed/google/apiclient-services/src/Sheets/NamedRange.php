...
class NamedRange extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\NamedRange::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_NamedRange');
