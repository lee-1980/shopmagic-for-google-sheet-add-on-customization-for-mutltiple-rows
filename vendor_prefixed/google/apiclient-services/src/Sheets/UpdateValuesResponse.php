...
class UpdateValuesResponse extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\UpdateValuesResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_UpdateValuesResponse');
