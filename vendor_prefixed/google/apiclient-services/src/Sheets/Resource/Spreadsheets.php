...
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateSpreadsheetRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateSpreadsheetResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GetSpreadsheetByDataFilterRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Spreadsheet;
/**
 ...
 *  </code>
 */
class Spreadsheets extends \ShopMagicGoogleSheetsVendor\Google\Service\Resource
{
    /**
     ...
     */
    public function batchUpdate($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateSpreadsheetRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchUpdate', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateSpreadsheetResponse::class);
    }
    /**
     ...
     * @return Spreadsheet
     */
    public function create(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Spreadsheet $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Spreadsheet::class);
    }
    /**
    ...
    public function get($spreadsheetId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Spreadsheet::class);
    }
    /**
     * Returns the spreadsheet at the given ID. The caller must specify the
     ...
     * @return Spreadsheet
     */
    public function getByDataFilter($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GetSpreadsheetByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('getByDataFilter', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Spreadsheet::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Resource\Spreadsheets::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_Resource_Spreadsheets');
