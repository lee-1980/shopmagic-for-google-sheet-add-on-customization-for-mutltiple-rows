...
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\AppendValuesResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesByDataFilterRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesByDataFilterResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchGetValuesByDataFilterRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchGetValuesByDataFilterResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchGetValuesResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ClearValuesRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ClearValuesResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\UpdateValuesResponse;
use ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ValueRange;
/**
 ...
 *  </code>
 */
class SpreadsheetsValues extends \ShopMagicGoogleSheetsVendor\Google\Service\Resource
{
    /**
     ...
     */
    public function append($spreadsheetId, $range, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ValueRange $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'range' => $range, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('append', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\AppendValuesResponse::class);
    }
    /**
     ...
     */
    public function batchClear($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchClear', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesResponse::class);
    }
    /**
     * Clears one or more ranges of values from a spreadsheet. The caller must
     ...
     */
    public function batchClearByDataFilter($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchClearByDataFilter', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchClearValuesByDataFilterResponse::class);
    }
    /**
    ...
    public function batchGet($spreadsheetId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('batchGet', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchGetValuesResponse::class);
    }
    /**
     ...
     */
    public function batchGetByDataFilter($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchGetValuesByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchGetByDataFilter', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchGetValuesByDataFilterResponse::class);
    }
    /**
     ...
     */
    public function batchUpdate($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchUpdate', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesResponse::class);
    }
    /**
     * Sets values in one or more ranges of a spreadsheet. The caller must specify
     ...
     */
    public function batchUpdateByDataFilter($spreadsheetId, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchUpdateByDataFilter', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterResponse::class);
    }
    /**
     ...
     */
    public function clear($spreadsheetId, $range, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ClearValuesRequest $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'range' => $range, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('clear', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ClearValuesResponse::class);
    }
    /**
    ...
    public function get($spreadsheetId, $range, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ValueRange::class);
    }
    /**
     ...
     */
    public function update($spreadsheetId, $range, \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ValueRange $postBody, $optParams = [])
    {
        $params = ['spreadsheetId' => $spreadsheetId, 'range' => $range, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\UpdateValuesResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Resource\SpreadsheetsValues::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_Resource_SpreadsheetsValues');
