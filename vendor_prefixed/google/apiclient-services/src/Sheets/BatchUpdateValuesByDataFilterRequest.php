...
class BatchUpdateValuesByDataFilterRequest extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'data';
    protected $dataType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataFilterValueRange::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BatchUpdateValuesByDataFilterRequest');
