...
class PivotFilterSpec extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
    ...
    protected $filterCriteriaType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\PivotFilterCriteria::class;
     ...
     */
    public function setFilterCriteria(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\PivotFilterCriteria $filterCriteria)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\PivotFilterSpec::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_PivotFilterSpec');
