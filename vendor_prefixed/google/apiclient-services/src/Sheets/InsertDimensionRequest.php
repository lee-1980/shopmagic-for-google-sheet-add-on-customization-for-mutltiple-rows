...
class InsertDimensionRequest extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\InsertDimensionRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_InsertDimensionRequest');
