...
class DuplicateSheetRequest extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DuplicateSheetRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DuplicateSheetRequest');
