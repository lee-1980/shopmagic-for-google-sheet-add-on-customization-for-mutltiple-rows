...
class DeleteDuplicatesResponse extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DeleteDuplicatesResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DeleteDuplicatesResponse');
