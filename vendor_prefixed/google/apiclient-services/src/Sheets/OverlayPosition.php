...
class OverlayPosition extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    protected $anchorCellType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridCoordinate::class;
     ...
     */
    public function setAnchorCell(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridCoordinate $anchorCell)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\OverlayPosition::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_OverlayPosition');
