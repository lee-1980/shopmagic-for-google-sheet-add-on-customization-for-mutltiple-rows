...
class UpdateSheetPropertiesRequest extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\UpdateSheetPropertiesRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_UpdateSheetPropertiesRequest');
