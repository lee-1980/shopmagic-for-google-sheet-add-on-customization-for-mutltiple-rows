...
class TextFormat extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
     ...
     */
    public $italic;
    protected $linkType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Link::class;
     ...
     * @param Link
     */
    public function setLink(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Link $link)
    {
        $this->link = $link;
    }
    /**
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\TextFormat::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_TextFormat');
