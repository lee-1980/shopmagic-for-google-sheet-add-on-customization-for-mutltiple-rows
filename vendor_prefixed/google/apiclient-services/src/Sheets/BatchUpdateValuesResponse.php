...
class BatchUpdateValuesResponse extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'responses';
    protected $responsesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\UpdateValuesResponse::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BatchUpdateValuesResponse');
