...
class BatchUpdateValuesRequest extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'data';
    protected $dataType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ValueRange::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BatchUpdateValuesRequest');
