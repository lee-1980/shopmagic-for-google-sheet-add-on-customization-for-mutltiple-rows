...
class BatchUpdateSpreadsheetRequest extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $requestsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Request::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateSpreadsheetRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BatchUpdateSpreadsheetRequest');
