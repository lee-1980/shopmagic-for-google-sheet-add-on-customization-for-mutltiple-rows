...
class TrimWhitespaceResponse extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\TrimWhitespaceResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_TrimWhitespaceResponse');
