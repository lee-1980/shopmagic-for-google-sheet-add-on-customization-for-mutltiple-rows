...
class SlicerSpec extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
     ...
     */
    public $columnIndex;
    protected $dataRangeType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridRange::class;
    protected $dataRangeDataType = '';
    protected $filterCriteriaType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\FilterCriteria::class;
     ...
     * @param GridRange
     */
    public function setDataRange(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridRange $dataRange)
    {
     ...
     */
    public function setFilterCriteria(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\FilterCriteria $filterCriteria)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\SlicerSpec::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_SlicerSpec');
