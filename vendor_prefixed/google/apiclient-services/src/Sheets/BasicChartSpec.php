...
class BasicChartSpec extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'series';
    protected $axisType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BasicChartAxis::class;
     ...
     */
    public $compareMode;
    protected $domainsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BasicChartDomain::class;
    ...
    protected $seriesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BasicChartSeries::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BasicChartSpec::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BasicChartSpec');
