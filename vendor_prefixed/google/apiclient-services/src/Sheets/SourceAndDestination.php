...
class SourceAndDestination extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\SourceAndDestination::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_SourceAndDestination');
