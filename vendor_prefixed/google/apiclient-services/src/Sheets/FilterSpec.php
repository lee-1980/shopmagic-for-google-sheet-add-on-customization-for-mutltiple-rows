...
class FilterSpec extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\FilterSpec::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_FilterSpec');
