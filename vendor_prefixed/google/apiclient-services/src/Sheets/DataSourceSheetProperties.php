...
class DataSourceSheetProperties extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'columns';
    protected $columnsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSourceColumn::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSourceSheetProperties::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DataSourceSheetProperties');
