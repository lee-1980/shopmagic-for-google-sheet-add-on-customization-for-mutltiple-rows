...
class DeveloperMetadataLookup extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
     ...
     */
    public $metadataKey;
    protected $metadataLocationType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DeveloperMetadataLocation::class;
     ...
     */
    public function setMetadataLocation(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DeveloperMetadataLocation $metadataLocation)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DeveloperMetadataLookup::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DeveloperMetadataLookup');
