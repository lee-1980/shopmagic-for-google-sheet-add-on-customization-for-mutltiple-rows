...
class ProtectedRange extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
     ...
     */
    public $description;
    protected $editorsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Editors::class;
    ...
    protected $unprotectedRangesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridRange::class;
     ...
     * @param Editors
     */
    public function setEditors(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Editors $editors)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\ProtectedRange::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_ProtectedRange');
