...
class SearchDeveloperMetadataResponse extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'matchedDeveloperMetadata';
    protected $matchedDeveloperMetadataType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\MatchedDeveloperMetadata::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\SearchDeveloperMetadataResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_SearchDeveloperMetadataResponse');
