...
class DataSourceTable extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $columnsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSourceColumnReference::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSourceTable::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DataSourceTable');
