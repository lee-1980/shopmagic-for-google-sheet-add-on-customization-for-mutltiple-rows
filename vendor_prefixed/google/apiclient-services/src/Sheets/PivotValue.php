...
class PivotValue extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\PivotValue::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_PivotValue');
