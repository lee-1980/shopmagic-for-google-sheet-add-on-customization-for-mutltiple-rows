...
class DataSourceParameter extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSourceParameter::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_DataSourceParameter');
