...
class TextToColumnsRequest extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\TextToColumnsRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_TextToColumnsRequest');
