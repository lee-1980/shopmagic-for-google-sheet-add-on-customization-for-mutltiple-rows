...
class Spreadsheet extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'sheets';
    protected $dataSourceSchedulesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSourceRefreshSchedule::class;
    protected $dataSourceSchedulesDataType = 'array';
    protected $dataSourcesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\DataSource::class;
    ...
    protected $namedRangesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\NamedRange::class;
    protected $namedRangesDataType = 'array';
    protected $propertiesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\SpreadsheetProperties::class;
    protected $propertiesDataType = '';
    protected $sheetsType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Sheet::class;
     ...
     */
    public function setProperties(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\SpreadsheetProperties $properties)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\Spreadsheet::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_Spreadsheet');
