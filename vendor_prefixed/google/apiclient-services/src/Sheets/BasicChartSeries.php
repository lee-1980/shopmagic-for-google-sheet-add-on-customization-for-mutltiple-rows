...
class BasicChartSeries extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $lineStyleType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\LineStyle::class;
    ...
    protected $styleOverridesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BasicSeriesDataPointStyleOverride::class;
     ...
     * @param LineStyle
     */
    public function setLineStyle(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\LineStyle $lineStyle)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BasicChartSeries::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BasicChartSeries');
