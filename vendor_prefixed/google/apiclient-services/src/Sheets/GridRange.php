...
class GridRange extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\GridRange::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_GridRange');
