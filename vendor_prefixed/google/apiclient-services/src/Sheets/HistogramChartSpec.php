...
class HistogramChartSpec extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $seriesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\HistogramSeries::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\HistogramChartSpec::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_HistogramChartSpec');
