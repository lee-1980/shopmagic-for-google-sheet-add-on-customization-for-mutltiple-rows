...
class BatchUpdateValuesByDataFilterResponse extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'responses';
    protected $responsesType = \ShopMagicGoogleSheetsVendor\Google\Service\Sheets\UpdateValuesByDataFilterResponse::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Sheets\BatchUpdateValuesByDataFilterResponse::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Sheets_BatchUpdateValuesByDataFilterResponse');
