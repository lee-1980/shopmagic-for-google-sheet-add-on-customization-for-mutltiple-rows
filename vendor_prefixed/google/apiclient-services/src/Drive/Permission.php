...
class Permission extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
     ...
     */
    public $pendingOwner;
    protected $permissionDetailsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\PermissionPermissionDetails::class;
     ...
     */
    public $role;
    protected $teamDrivePermissionDetailsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\PermissionTeamDrivePermissionDetails::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\Permission::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_Permission');
