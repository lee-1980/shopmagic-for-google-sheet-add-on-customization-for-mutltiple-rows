...
class DriveCapabilities extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveCapabilities::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveCapabilities');
