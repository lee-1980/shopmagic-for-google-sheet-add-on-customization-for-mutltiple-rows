...
class DriveFileCapabilities extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileCapabilities::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveFileCapabilities');
