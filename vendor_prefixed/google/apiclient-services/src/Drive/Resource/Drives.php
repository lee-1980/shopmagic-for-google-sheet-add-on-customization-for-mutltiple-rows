...
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveList;
/**
 ...
 *  </code>
 */
class Drives extends \ShopMagicGoogleSheetsVendor\Google\Service\Resource
{
    /**
     ...
     * @return Drive
     */
    public function create($requestId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive $postBody, $optParams = [])
    {
        $params = ['requestId' => $requestId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive::class);
    }
    /**
    ...
    public function get($driveId, $optParams = [])
    {
        $params = ['driveId' => $driveId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive::class);
    }
    /**
    ...
    public function hide($driveId, $optParams = [])
    {
        $params = ['driveId' => $driveId];
        $params = \array_merge($params, $optParams);
        return $this->call('hide', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive::class);
    }
    /**
    ...
    public function listDrives($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveList::class);
    }
    /**
    ...
    public function unhide($driveId, $optParams = [])
    {
        $params = ['driveId' => $driveId];
        $params = \array_merge($params, $optParams);
        return $this->call('unhide', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive::class);
    }
    /**
     ...
     * @return Drive
     */
    public function update($driveId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive $postBody, $optParams = [])
    {
        $params = ['driveId' => $driveId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Drive::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\Resource\Drives::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_Resource_Drives');
