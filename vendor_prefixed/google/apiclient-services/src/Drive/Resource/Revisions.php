...
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\Revision;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\RevisionList;
/**
 ...
 *  </code>
 */
class Revisions extends \ShopMagicGoogleSheetsVendor\Google\Service\Resource
{
    /**
    ...
    public function get($fileId, $revisionId, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'revisionId' => $revisionId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Revision::class);
    }
    /**
    ...
    public function listRevisions($fileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\RevisionList::class);
    }
    /**
     ...
     * @return Revision
     */
    public function update($fileId, $revisionId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Revision $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Revision::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\Resource\Revisions::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_Resource_Revisions');
