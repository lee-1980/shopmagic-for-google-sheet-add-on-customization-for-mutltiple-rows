...
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\ChangeList;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\Channel;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\StartPageToken;
/**
 ...
 *  </code>
 */
class Changes extends \ShopMagicGoogleSheetsVendor\Google\Service\Resource
{
    /**
    ...
    public function getStartPageToken($optParams = [])
    {
        ...
        return $this->call('getStartPageToken', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\StartPageToken::class);
    }
    /**
    ...
    public function listChanges($pageToken, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\ChangeList::class);
    }
    /**
     ...
     * @return Channel
     */
    public function watch($pageToken, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Channel $postBody, $optParams = [])
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\Resource\Changes::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_Resource_Changes');
