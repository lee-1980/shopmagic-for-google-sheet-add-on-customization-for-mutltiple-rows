 ...
 * the License.
 */
namespace ShopMagicGoogleSheetsVendor\Google\Service\Drive\Resource;

use ShopMagicGoogleSheetsVendor\Google\Service\Drive\Channel;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\FileList;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\GeneratedIds;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\LabelList;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\ModifyLabelsRequest;
use ShopMagicGoogleSheetsVendor\Google\Service\Drive\ModifyLabelsResponse;
/**
 ...
 *  </code>
 */
class Files extends \ShopMagicGoogleSheetsVendor\Google\Service\Resource
{
    /**
     ...
     * @return DriveFile
     */
    public function copy($fileId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('copy', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile::class);
    }
    /**
     ...
     * @return DriveFile
     */
    public function create(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile $postBody, $optParams = [])
    {
        $params = ['postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('create', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile::class);
    }
    /**
    ...
    public function generateIds($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('generateIds', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\GeneratedIds::class);
    }
    /**
    ...
    public function get($fileId, $optParams = [])
    {
        $params = ['fileId' => $fileId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile::class);
    }
    /**
    ...
    public function listFiles($optParams = [])
    {
        $params = [];
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\FileList::class);
    }
    /**
    ...
    public function listLabels($fileId, $optParams = [])
    {
        $params = ['fileId' => $fileId];
        $params = \array_merge($params, $optParams);
        return $this->call('listLabels', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\LabelList::class);
    }
    /**
     ...
     */
    public function modifyLabels($fileId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\ModifyLabelsRequest $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('modifyLabels', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\ModifyLabelsResponse::class);
    }
    /**
     ...
     * @return DriveFile
     */
    public function update($fileId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile::class);
    }
    /**
     ...
     * @return Channel
     */
    public function watch($fileId, \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Channel $postBody, $optParams = [])
    {
        $params = ['fileId' => $fileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('watch', [$params], \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Channel::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\Resource\Files::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_Resource_Files');
