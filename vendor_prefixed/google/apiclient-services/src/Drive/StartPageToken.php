...
class StartPageToken extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\StartPageToken::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_StartPageToken');
