...
class DriveRestrictions extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveRestrictions::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveRestrictions');
