...
class AboutStorageQuota extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\AboutStorageQuota::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_AboutStorageQuota');
