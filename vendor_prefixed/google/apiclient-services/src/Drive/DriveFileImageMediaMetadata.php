...
class DriveFileImageMediaMetadata extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var float
     */
     ...
     */
    public $lens;
    protected $locationType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileImageMediaMetadataLocation::class;
     ...
     */
    public function setLocation(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileImageMediaMetadataLocation $location)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileImageMediaMetadata::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveFileImageMediaMetadata');
