...
class DriveFileShortcutDetails extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileShortcutDetails::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveFileShortcutDetails');
