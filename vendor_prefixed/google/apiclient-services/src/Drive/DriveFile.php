...
class DriveFile extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $capabilitiesType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileCapabilities::class;
    protected $capabilitiesDataType = '';
    protected $contentHintsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileContentHints::class;
    protected $contentHintsDataType = '';
    protected $contentRestrictionsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\ContentRestriction::class;
     ...
     */
    public $id;
    protected $imageMediaMetadataType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileImageMediaMetadata::class;
     ...
     */
    public $kind;
    protected $labelInfoType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileLabelInfo::class;
    protected $labelInfoDataType = '';
    protected $lastModifyingUserType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\User::class;
    protected $lastModifyingUserDataType = '';
    protected $linkShareMetadataType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileLinkShareMetadata::class;
     ...
     */
    public $ownedByMe;
    protected $ownersType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\User::class;
    ...
    protected $permissionsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\Permission::class;
    ...
    protected $sharingUserType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\User::class;
    protected $sharingUserDataType = '';
    protected $shortcutDetailsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileShortcutDetails::class;
     ...
     */
    public $trashedTime;
    protected $trashingUserType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\User::class;
    protected $trashingUserDataType = '';
    /**
     * @var string
     */
    public $version;
    protected $videoMediaMetadataType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileVideoMediaMetadata::class;
     ...
     */
    public function setCapabilities(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileCapabilities $capabilities)
    {
     ...
     */
    public function setContentHints(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileContentHints $contentHints)
    {
     ...
     */
    public function setImageMediaMetadata(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileImageMediaMetadata $imageMediaMetadata)
    {
     ...
     */
    public function setLabelInfo(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileLabelInfo $labelInfo)
    {
     ...
     * @param User
     */
    public function setLastModifyingUser(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\User $lastModifyingUser)
    {
     ...
     */
    public function setLinkShareMetadata(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileLinkShareMetadata $linkShareMetadata)
    {
     ...
     * @param User
     */
    public function setSharingUser(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\User $sharingUser)
    {
     ...
     */
    public function setShortcutDetails(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileShortcutDetails $shortcutDetails)
    {
     ...
     * @param User
     */
    public function setTrashingUser(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\User $trashingUser)
    {
     ...
     */
    public function setVideoMediaMetadata(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileVideoMediaMetadata $videoMediaMetadata)
    {
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFile::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveFile');
