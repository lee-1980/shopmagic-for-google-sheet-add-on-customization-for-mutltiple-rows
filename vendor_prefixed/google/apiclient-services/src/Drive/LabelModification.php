...
class LabelModification extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    protected $collection_key = 'fieldModifications';
    protected $fieldModificationsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\LabelFieldModification::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\LabelModification::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_LabelModification');
