...
class DriveFileLinkShareMetadata extends \ShopMagicGoogleSheetsVendor\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\DriveFileLinkShareMetadata::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_DriveFileLinkShareMetadata');
