...
class ModifyLabelsRequest extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
     ...
     */
    public $kind;
    protected $labelModificationsType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\LabelModification::class;
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\ModifyLabelsRequest::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_ModifyLabelsRequest');
