...
class About extends \ShopMagicGoogleSheetsVendor\Google\Collection
{
    ...
    protected $driveThemesType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\AboutDriveThemes::class;
    ...
    protected $storageQuotaType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\AboutStorageQuota::class;
    protected $storageQuotaDataType = '';
    protected $teamDriveThemesType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\AboutTeamDriveThemes::class;
    protected $teamDriveThemesDataType = 'array';
    protected $userType = \ShopMagicGoogleSheetsVendor\Google\Service\Drive\User::class;
     ...
     */
    public function setStorageQuota(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\AboutStorageQuota $storageQuota)
    {
     ...
     * @param User
     */
    public function setUser(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\User $user)
    {
        $this->user = $user;
    }
    /**
...
\class_alias(\ShopMagicGoogleSheetsVendor\Google\Service\Drive\About::class, 'ShopMagicGoogleSheetsVendor\\Google_Service_Drive_About');
