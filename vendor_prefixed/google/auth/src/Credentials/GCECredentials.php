 ...
 */
namespace ShopMagicGoogleSheetsVendor\Google\Auth\Credentials;

use ShopMagicGoogleSheetsVendor\Google\Auth\CredentialsLoader;
use ShopMagicGoogleSheetsVendor\Google\Auth\GetQuotaProjectInterface;
...
use ShopMagicGoogleSheetsVendor\Google\Auth\Iam;
use ShopMagicGoogleSheetsVendor\Google\Auth\IamSignerTrait;
use ShopMagicGoogleSheetsVendor\Google\Auth\ProjectIdProviderInterface;
use ShopMagicGoogleSheetsVendor\Google\Auth\SignBlobInterface;
use ShopMagicGoogleSheetsVendor\GuzzleHttp\Exception\ClientException;
...
use ShopMagicGoogleSheetsVendor\GuzzleHttp\Exception\ServerException;
 ...
 */
class GCECredentials extends \ShopMagicGoogleSheetsVendor\Google\Auth\CredentialsLoader implements \ShopMagicGoogleSheetsVendor\Google\Auth\SignBlobInterface, \ShopMagicGoogleSheetsVendor\Google\Auth\ProjectIdProviderInterface, \ShopMagicGoogleSheetsVendor\Google\Auth\GetQuotaProjectInterface
{
    use IamSignerTrait;
    // phpcs:disable
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\Google\Auth\Iam $iam = null, $scope = null, $targetAudience = null, $quotaProject = null, $serviceAccountIdentity = null)
    {
        $this->iam = $iam;
    ...
    {
        $httpHandler = $httpHandler ?: \ShopMagicGoogleSheetsVendor\Google\Auth\HttpHandler\HttpHandlerFactory::build(\ShopMagicGoogleSheetsVendor\Google\Auth\HttpHandler\HttpClientCache::getHttpClient());
        ...
        for ($i = 1; $i <= self::MAX_COMPUTE_PING_TRIES; $i++) {
            try {
                ...
                // the metadata resolution was particularly slow. The latter case is
                // "unlikely".
                $resp = $httpHandler(new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Request('GET', $checkUri, [self::FLAVOR_HEADER => 'Google']), ['timeout' => self::COMPUTE_PING_CONNECTION_TIMEOUT_S]);
                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'Google';
            } catch (\ShopMagicGoogleSheetsVendor\GuzzleHttp\Exception\ClientException $e) {
            } catch (\ShopMagicGoogleSheetsVendor\GuzzleHttp\Exception\ServerException $e) {
            } catch (\ShopMagicGoogleSheetsVendor\GuzzleHttp\Exception\RequestException $e) {
            } catch (\ShopMagicGoogleSheetsVendor\GuzzleHttp\Exception\ConnectException $e) {
            }
        }
        return \false;
    }
    ...
    {
        $resp = $httpHandler(new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Request('GET', $uri, [self::FLAVOR_HEADER => 'Google']));
