...
use ShopMagicGoogleSheetsVendor\Google\Auth\ServiceAccountSignerTrait;
 ...
 */
class ServiceAccountCredentials extends \ShopMagicGoogleSheetsVendor\Google\Auth\CredentialsLoader implements \ShopMagicGoogleSheetsVendor\Google\Auth\GetQuotaProjectInterface, \ShopMagicGoogleSheetsVendor\Google\Auth\SignBlobInterface, \ShopMagicGoogleSheetsVendor\Google\Auth\ProjectIdProviderInterface
{
    ...
    public function __construct($scope, $jsonKey, $sub = null, $targetAudience = null)
    {
        ...
        $this->auth = new \ShopMagicGoogleSheetsVendor\Google\Auth\OAuth2(['audience' => self::TOKEN_CREDENTIAL_URI, 'issuer' => $jsonKey['client_email'], 'scope' => $scope, 'signingAlgorithm' => 'RS256', 'signingKey' => $jsonKey['private_key'], 'sub' => $sub, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI, 'additionalClaims' => $additionalClaims]);
    ...
    private function createJwtAccessCredentials()
    {
        if (!$this->jwtAccessCredentials) {
            ...
            $this->jwtAccessCredentials = new \ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\ServiceAccountJwtAccessCredentials($credJson, $this->auth->getScope());
        }
