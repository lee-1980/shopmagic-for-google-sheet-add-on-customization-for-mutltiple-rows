 ...
 */
use ShopMagicGoogleSheetsVendor\google\appengine\api\app_identity\AppIdentityService;
 ...
 * ```
 */
class AppIdentityCredentials extends \ShopMagicGoogleSheetsVendor\Google\Auth\CredentialsLoader implements \ShopMagicGoogleSheetsVendor\Google\Auth\SignBlobInterface, \ShopMagicGoogleSheetsVendor\Google\Auth\ProjectIdProviderInterface
{
    /**
    ...
    public function fetchAuthToken(callable $httpHandler = null)
    {
        ...
        $token = \ShopMagicGoogleSheetsVendor\google\appengine\api\app_identity\AppIdentityService::getAccessToken($this->scope);
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false)
    {
        $this->checkAppEngineContext();
        /** @phpstan-ignore-next-line */
        return \base64_encode(\ShopMagicGoogleSheetsVendor\google\appengine\api\app_identity\AppIdentityService::signForApp($stringToSign)['signature']);
    }
    /**
    ...
    public function getProjectId(callable $httpHandler = null)
    {
        ...
        /** @phpstan-ignore-next-line */
        return \ShopMagicGoogleSheetsVendor\google\appengine\api\app_identity\AppIdentityService::getApplicationId();
    }
    /**
    ...
    public function getClientName(callable $httpHandler = null)
    {
        ...
        if (!$this->clientName) {
            /** @phpstan-ignore-next-line */
            $this->clientName = \ShopMagicGoogleSheetsVendor\google\appengine\api\app_identity\AppIdentityService::getServiceAccountName();
        }
    ...
    {
        if (!self::onAppEngine() || !\class_exists('ShopMagicGoogleSheetsVendor\\google\\appengine\\api\\app_identity\\AppIdentityService')) {
