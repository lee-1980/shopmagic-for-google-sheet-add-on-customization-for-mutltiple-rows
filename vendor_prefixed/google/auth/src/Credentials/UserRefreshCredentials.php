 ...
 */
class UserRefreshCredentials extends \ShopMagicGoogleSheetsVendor\Google\Auth\CredentialsLoader implements \ShopMagicGoogleSheetsVendor\Google\Auth\GetQuotaProjectInterface
{
    /**
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->auth = new \ShopMagicGoogleSheetsVendor\Google\Auth\OAuth2(['clientId' => $jsonKey['client_id'], 'clientSecret' => $jsonKey['client_secret'], 'refresh_token' => $jsonKey['refresh_token'], 'scope' => $scope, 'tokenCredentialUri' => self::TOKEN_CREDENTIAL_URI]);
