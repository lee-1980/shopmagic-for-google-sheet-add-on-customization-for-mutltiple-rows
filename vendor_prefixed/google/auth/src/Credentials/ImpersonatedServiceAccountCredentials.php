...
class ImpersonatedServiceAccountCredentials extends \ShopMagicGoogleSheetsVendor\Google\Auth\CredentialsLoader implements \ShopMagicGoogleSheetsVendor\Google\Auth\SignBlobInterface
{
    use IamSignerTrait;
    /**
     * @var string
    ...
    public function __construct($scope, $jsonKey)
    {
        ...
        $this->sourceCredentials = new \ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\UserRefreshCredentials($scope, $jsonKey['source_credentials']);
    }
    /**
