...
use ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\InsecureCredentials;
 ...
 */
abstract class CredentialsLoader implements \ShopMagicGoogleSheetsVendor\Google\Auth\FetchAuthTokenInterface, \ShopMagicGoogleSheetsVendor\Google\Auth\UpdateMetadataInterface
{
    ...
    public static function makeCredentials($scope, array $jsonKey, $defaultScope = null)
    {
        ...
        if ($jsonKey['type'] == 'service_account') {
            ...
            return new \ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\ServiceAccountCredentials($scope, $jsonKey);
        }
        if ($jsonKey['type'] == 'authorized_user') {
            $anyScope = $scope ?: $defaultScope;
            return new \ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\UserRefreshCredentials($anyScope, $jsonKey);
        }
        if ($jsonKey['type'] == 'impersonated_service_account') {
            $anyScope = $scope ?: $defaultScope;
            return new \ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials($anyScope, $jsonKey);
        }
     ...
     */
    public static function makeHttpClient(\ShopMagicGoogleSheetsVendor\Google\Auth\FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        $middleware = new \ShopMagicGoogleSheetsVendor\Google\Auth\Middleware\AuthTokenMiddleware($fetcher, $httpHandler, $tokenCallback);
        $stack = \ShopMagicGoogleSheetsVendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
    ...
    {
        return new \ShopMagicGoogleSheetsVendor\Google\Auth\Credentials\InsecureCredentials();
    }
    /**
