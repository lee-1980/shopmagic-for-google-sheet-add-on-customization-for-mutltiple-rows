...
use ShopMagicGoogleSheetsVendor\Google\Auth\CacheTrait;
...
class ScopedAccessTokenMiddleware
{
     ...
     */
    public function __construct(callable $tokenFunc, $scopes, array $cacheConfig = null, \ShopMagicGoogleSheetsVendor\Psr\Cache\CacheItemPoolInterface $cache = null)
    {
