 ...
 */
namespace ShopMagicGoogleSheetsVendor\Google\Auth\Middleware;

use ShopMagicGoogleSheetsVendor\Google\Auth\FetchAuthTokenInterface;
...
class ProxyAuthTokenMiddleware
{
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\Google\Auth\FetchAuthTokenInterface $fetcher, callable $httpHandler = null, callable $tokenCallback = null)
    {
    ...
    {
        return function (\ShopMagicGoogleSheetsVendor\Psr\Http\Message\RequestInterface $request, array $options) use($handler) {
            ...
            if ($quotaProject = $this->getQuotaProject()) {
                $request = $request->withHeader(\ShopMagicGoogleSheetsVendor\Google\Auth\GetQuotaProjectInterface::X_GOOG_USER_PROJECT_HEADER, $quotaProject);
            }
            return $handler($request, $options);
        };
    }
