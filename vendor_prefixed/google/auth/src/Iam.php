...
class Iam
{
    ...
    public function signBlob($email, $accessToken, $stringToSign, array $delegates = [])
    {
        ...
        $request = new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Request('POST', $uri, $headers, \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Utils::streamFor(\json_encode($body)));
