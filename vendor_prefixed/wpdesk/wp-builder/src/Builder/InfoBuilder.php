 ...
 */
class InfoBuilder extends \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\ShopMagicGoogleSheetsVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
