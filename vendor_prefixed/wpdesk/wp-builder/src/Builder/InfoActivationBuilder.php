...
namespace ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Builder;
...
use ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
