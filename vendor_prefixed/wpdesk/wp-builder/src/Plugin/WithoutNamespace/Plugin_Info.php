...
if (!\interface_exists('ShopMagicGoogleSheetsVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('ShopMagicGoogleSheetsVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('ShopMagicGoogleSheetsVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \ShopMagicGoogleSheetsVendor\WPDesk_Translatable, \ShopMagicGoogleSheetsVendor\WPDesk_Buildable, \ShopMagicGoogleSheetsVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
