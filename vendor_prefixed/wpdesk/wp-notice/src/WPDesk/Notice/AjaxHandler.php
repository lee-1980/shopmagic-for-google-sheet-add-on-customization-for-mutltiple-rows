...
namespace ShopMagicGoogleSheetsVendor\WPDesk\Notice;

use ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $option_name = \ShopMagicGoogleSheetsVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            if (\wp_verify_nonce($security, $option_name)) {
                \update_option($option_name, \ShopMagicGoogleSheetsVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
