...
if (!\interface_exists('ShopMagicGoogleSheetsVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicGoogleSheetsVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \ShopMagicGoogleSheetsVendor\WPDesk_Requirement_Checker
    {
