 ...
 */
class OldLicenseRegistrator implements \ShopMagicGoogleSheetsVendor\WPDesk\License\PluginRegistratorInterface
{
    ...
    public function __construct(\ShopMagicGoogleSheetsVendor\WPDesk_Plugin_Info $plugin_info)
    {
        ...
        $this->plugin_license = new \ShopMagicGoogleSheetsVendor\WPDesk\License\PluginLicense($plugin_info);
    }
