...
namespace ShopMagicGoogleSheetsVendor\WPDesk\License\Page\License\Action;

use ShopMagicGoogleSheetsVendor\WPDesk\License\Page\Action;
use ShopMagicGoogleSheetsVendor\WPDesk\License\ServerAddressRepository;
 ...
 */
class LicenseActivation extends \ShopMagicGoogleSheetsVendor\WPDesk\License\Page\License\Action\AbstractAction implements \ShopMagicGoogleSheetsVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    public function execute(array $plugin)
    {
        ...
        $this->activate_license($activation_email, $api_key, new \ShopMagicGoogleSheetsVendor\WPDesk\License\ServerAddressRepository($product_id));
    }
    /**
     ...
     */
    public function activate_license($activation_email, $api_key, \ShopMagicGoogleSheetsVendor\WPDesk\License\ServerAddressRepository $address_repository)
    {
