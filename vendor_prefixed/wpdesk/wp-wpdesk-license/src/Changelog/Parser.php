...
namespace ShopMagicGoogleSheetsVendor\WPDesk\License\Changelog;

use ArrayObject;
use ShopMagicGoogleSheetsVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \ShopMagicGoogleSheetsVendor\WPDesk\License\Changelog\Parser\Line($line);
