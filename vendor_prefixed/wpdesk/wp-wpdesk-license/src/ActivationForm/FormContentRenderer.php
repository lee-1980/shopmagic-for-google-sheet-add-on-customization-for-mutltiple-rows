...
use ShopMagicGoogleSheetsVendor\WPDesk\License\Page\License\Action\ActionError;
...
class FormContentRenderer
{
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\WPDesk_Plugin_Info $plugin_info, bool $update_possible, array $errors = [])
    {
