 ...
 */
class PluginsPageRenderer implements \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /**
    ...
    public function output_render(string $plugin_file, $plugin_data)
    {
        ...
        $form_content = new \ShopMagicGoogleSheetsVendor\WPDesk\License\ActivationForm\Renderer($this->plugin_info, $update_possible);
