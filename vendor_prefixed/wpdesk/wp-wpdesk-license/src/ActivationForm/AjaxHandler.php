...
namespace ShopMagicGoogleSheetsVendor\WPDesk\License\ActivationForm;

use ShopMagicGoogleSheetsVendor\WPDesk\License\LicenseManager;
use ShopMagicGoogleSheetsVendor\WPDesk\License\Page\LicensePageActions;
use ShopMagicGoogleSheetsVendor\WPDesk\License\PluginLicense;
use ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\Hookable;
use ShopMagicGoogleSheetsVendor\WPDesk_Plugin_Info;
/**
 * Handles License Activation Ajax requests.
 */
class AjaxHandler implements \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $license_manager = new \ShopMagicGoogleSheetsVendor\WPDesk\License\LicenseManager($this->plugin_info);
        ...
        $license_page_action = (new \ShopMagicGoogleSheetsVendor\WPDesk\License\Page\LicensePageActions())->create_action($license_action, \false);
        ...
        $plugin_license = new \ShopMagicGoogleSheetsVendor\WPDesk\License\PluginLicense($this->plugin_info);
        $form_content_renderer = new \ShopMagicGoogleSheetsVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->is_update_possible(isset($update_plugins[$this->plugin_info->get_plugin_file_name()]) ?? new \stdClass()), $license_page_action->get_errors());
