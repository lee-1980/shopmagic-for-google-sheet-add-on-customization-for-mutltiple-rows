...
namespace ShopMagicGoogleSheetsVendor\WPDesk\License\WpUpgrader;

use ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\Hookable;
/**
 * Can handle plugin update for expired subscription.
 */
class SubscriptionHandler implements \ShopMagicGoogleSheetsVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
