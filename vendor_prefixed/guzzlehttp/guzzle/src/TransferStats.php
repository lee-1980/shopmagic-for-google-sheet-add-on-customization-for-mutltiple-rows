...
final class TransferStats
{
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\Psr\Http\Message\RequestInterface $request, ?\ShopMagicGoogleSheetsVendor\Psr\Http\Message\ResponseInterface $response = null, ?float $transferTime = null, $handlerErrorData = null, array $handlerStats = [])
    {
     ...
     */
    public function getEffectiveUri() : \ShopMagicGoogleSheetsVendor\Psr\Http\Message\UriInterface
    {
