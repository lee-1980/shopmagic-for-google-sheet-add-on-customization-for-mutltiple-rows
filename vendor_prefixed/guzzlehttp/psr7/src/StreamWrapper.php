...
final class StreamWrapper
{
     ...
     */
    public static function getResource(\ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface $stream)
    {
