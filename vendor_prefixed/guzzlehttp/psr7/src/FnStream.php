...
final class FnStream implements \ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface
{
     ...
     * @return FnStream
     */
    public static function decorate(\ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
