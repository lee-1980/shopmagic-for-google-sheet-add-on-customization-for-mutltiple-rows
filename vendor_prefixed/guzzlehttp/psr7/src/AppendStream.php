 ...
 */
final class AppendStream implements \ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface $stream) : void
    {
    ...
    {
        return \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
