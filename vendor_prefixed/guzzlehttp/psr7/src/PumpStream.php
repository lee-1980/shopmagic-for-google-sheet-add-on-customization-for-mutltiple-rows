 ...
 */
final class PumpStream implements \ShopMagicGoogleSheetsVendor\Psr\Http\Message\StreamInterface
{
    /** @var callable|null */
    private $source;
    /** @var int|null */
    ...
    public function __construct(callable $source, array $options = [])
    {
        ...
        $this->buffer = new \ShopMagicGoogleSheetsVendor\GuzzleHttp\Psr7\BufferStream();
    }
