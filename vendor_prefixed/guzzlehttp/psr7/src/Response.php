 ...
 */
class Response implements \ShopMagicGoogleSheetsVendor\Psr\Http\Message\ResponseInterface
{
    use MessageTrait;
    ...
    public function withStatus($code, $reasonPhrase = '') : \ShopMagicGoogleSheetsVendor\Psr\Http\Message\ResponseInterface
    {
