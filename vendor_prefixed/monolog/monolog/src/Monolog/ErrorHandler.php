 ...
 */
namespace ShopMagicGoogleSheetsVendor\Monolog;

use ShopMagicGoogleSheetsVendor\Psr\Log\LoggerInterface;
use ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel;
/**
...
class ErrorHandler
{
    ...
    /** @var LogLevel::* */
    private $fatalLevel = \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ALERT;
    /** @var ?string */
    ...
    public function __construct(\ShopMagicGoogleSheetsVendor\Psr\Log\LoggerInterface $logger)
    {
        $this->logger = $logger;
    }
    /**
     ...
     * @return ErrorHandler
     */
    public static function register(\ShopMagicGoogleSheetsVendor\Psr\Log\LoggerInterface $logger, $errorLevelMap = [], $exceptionLevelMap = [], $fatalLevel = null) : self
    {
    ...
    public function registerFatalHandler($level = null, int $reservedMemorySize = 20) : self
    {
        ...
        $this->fatalLevel = null === $level ? \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ALERT : $level;
    ...
    {
        return ['ParseError' => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::CRITICAL, 'Throwable' => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ERROR];
    }
    /**
    ...
    {
        return [\E_ERROR => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::CRITICAL, \E_WARNING => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::WARNING, \E_PARSE => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ALERT, \E_NOTICE => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::NOTICE, \E_CORE_ERROR => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::CRITICAL, \E_CORE_WARNING => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::WARNING, \E_COMPILE_ERROR => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ALERT, \E_COMPILE_WARNING => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::WARNING, \E_USER_ERROR => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ERROR, \E_USER_WARNING => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::WARNING, \E_USER_NOTICE => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::NOTICE, \E_STRICT => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::NOTICE, \E_RECOVERABLE_ERROR => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ERROR, \E_DEPRECATED => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::NOTICE, \E_USER_DEPRECATED => \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::NOTICE];
    }
    /**
    ...
    {
        $level = \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::ERROR;
        ...
        $this->logger->log($level, \sprintf('Uncaught Exception %s: "%s" at %s line %s', \ShopMagicGoogleSheetsVendor\Monolog\Utils::getClass($e), $e->getMessage(), $e->getFile(), $e->getLine()), ['exception' => $e]);
    ...
    public function handleError(int $code, string $message, string $file = '', int $line = 0, ?array $context = []) : bool
    {
        ...
        if (!$this->hasFatalErrorHandler || !\in_array($code, self::$fatalErrors, \true)) {
            $level = $this->errorLevelMap[$code] ?? \ShopMagicGoogleSheetsVendor\Psr\Log\LogLevel::CRITICAL;
    ...
    public function handleFatalError() : void
    {
        ...
        if ($lastError && \in_array($lastError['type'], self::$fatalErrors, \true)) {
            ...
            if ($this->logger instanceof \ShopMagicGoogleSheetsVendor\Monolog\Logger) {
