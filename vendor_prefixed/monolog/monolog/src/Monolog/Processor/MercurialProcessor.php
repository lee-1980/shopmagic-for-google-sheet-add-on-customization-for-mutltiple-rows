 ...
 */
class MercurialProcessor implements \ShopMagicGoogleSheetsVendor\Monolog\Processor\ProcessorInterface
{
    /** @var Level */
    private $level;
     ...
     */
    public function __construct($level = \ShopMagicGoogleSheetsVendor\Monolog\Logger::DEBUG)
    {
