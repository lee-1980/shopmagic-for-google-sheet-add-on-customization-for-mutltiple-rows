...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\ShopMagicGoogleSheetsVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \ShopMagicGoogleSheetsVendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \ShopMagicGoogleSheetsVendor\Monolog\Logger
    {
