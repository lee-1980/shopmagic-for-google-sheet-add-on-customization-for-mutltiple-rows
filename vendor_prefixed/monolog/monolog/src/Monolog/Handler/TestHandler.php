 ...
 */
class TestHandler extends \ShopMagicGoogleSheetsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\ShopMagicGoogleSheetsVendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
