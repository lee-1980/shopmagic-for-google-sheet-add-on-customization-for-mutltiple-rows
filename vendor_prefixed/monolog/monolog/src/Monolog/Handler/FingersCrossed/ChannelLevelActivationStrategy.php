 ...
 */
namespace ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed;
 ...
 */
class ChannelLevelActivationStrategy implements \ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \ShopMagicGoogleSheetsVendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
