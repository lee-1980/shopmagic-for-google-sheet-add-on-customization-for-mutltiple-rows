...
use ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
 ...
 */
class FingersCrossedHandler extends \ShopMagicGoogleSheetsVendor\Monolog\Handler\Handler implements \ShopMagicGoogleSheetsVendor\Monolog\Handler\ProcessableHandlerInterface, \ShopMagicGoogleSheetsVendor\Monolog\ResettableInterface, \ShopMagicGoogleSheetsVendor\Monolog\Handler\FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = \true, bool $stopBuffering = \true, $passthruLevel = null)
    {
        if (null === $activationStrategy) {
            $activationStrategy = new \ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(\ShopMagicGoogleSheetsVendor\Monolog\Logger::WARNING);
        }
        // convert simple int activationStrategy to an object
        if (!$activationStrategy instanceof \ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface) {
            $activationStrategy = new \ShopMagicGoogleSheetsVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy($activationStrategy);
        }
        ...
        if ($passthruLevel !== null) {
            $this->passthruLevel = \ShopMagicGoogleSheetsVendor\Monolog\Logger::toMonologLevel($passthruLevel);
        }
        if (!$this->handler instanceof \ShopMagicGoogleSheetsVendor\Monolog\Handler\HandlerInterface && !\is_callable($this->handler)) {
    ...
    public function reset()
    {
        ...
        if ($this->getHandler() instanceof \ShopMagicGoogleSheetsVendor\Monolog\ResettableInterface) {
    ...
    {
        if (!$this->handler instanceof \ShopMagicGoogleSheetsVendor\Monolog\Handler\HandlerInterface) {
    ...
    public function setFormatter(\ShopMagicGoogleSheetsVendor\Monolog\Formatter\FormatterInterface $formatter) : \ShopMagicGoogleSheetsVendor\Monolog\Handler\HandlerInterface
    {
        ...
        if ($handler instanceof \ShopMagicGoogleSheetsVendor\Monolog\Handler\FormattableHandlerInterface) {
