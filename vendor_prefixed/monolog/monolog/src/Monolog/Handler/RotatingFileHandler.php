 ...
 */
class RotatingFileHandler extends \ShopMagicGoogleSheetsVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \ShopMagicGoogleSheetsVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \ShopMagicGoogleSheetsVendor\Monolog\Utils::canonicalizePath($filename);
