 ...
 */
abstract class AbstractSyslogHandler extends \ShopMagicGoogleSheetsVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var int */
    protected $facility;
    /**
     ...
     */
    protected $logLevels = [\ShopMagicGoogleSheetsVendor\Monolog\Logger::DEBUG => \LOG_DEBUG, \ShopMagicGoogleSheetsVendor\Monolog\Logger::INFO => \LOG_INFO, \ShopMagicGoogleSheetsVendor\Monolog\Logger::NOTICE => \LOG_NOTICE, \ShopMagicGoogleSheetsVendor\Monolog\Logger::WARNING => \LOG_WARNING, \ShopMagicGoogleSheetsVendor\Monolog\Logger::ERROR => \LOG_ERR, \ShopMagicGoogleSheetsVendor\Monolog\Logger::CRITICAL => \LOG_CRIT, \ShopMagicGoogleSheetsVendor\Monolog\Logger::ALERT => \LOG_ALERT, \ShopMagicGoogleSheetsVendor\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \ShopMagicGoogleSheetsVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \ShopMagicGoogleSheetsVendor\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
