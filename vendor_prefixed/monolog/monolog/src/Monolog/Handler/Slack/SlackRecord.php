 ...
 */
namespace ShopMagicGoogleSheetsVendor\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \ShopMagicGoogleSheetsVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \ShopMagicGoogleSheetsVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \ShopMagicGoogleSheetsVendor\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \ShopMagicGoogleSheetsVendor\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \ShopMagicGoogleSheetsVendor\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \ShopMagicGoogleSheetsVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \ShopMagicGoogleSheetsVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \ShopMagicGoogleSheetsVendor\Monolog\Utils::jsonEncode($normalized, \ShopMagicGoogleSheetsVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\ShopMagicGoogleSheetsVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
