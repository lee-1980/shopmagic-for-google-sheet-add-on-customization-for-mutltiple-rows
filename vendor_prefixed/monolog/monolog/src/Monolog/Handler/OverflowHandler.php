 ...
 */
class OverflowHandler extends \ShopMagicGoogleSheetsVendor\Monolog\Handler\AbstractHandler implements \ShopMagicGoogleSheetsVendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\ShopMagicGoogleSheetsVendor\Monolog\Logger::DEBUG => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::INFO => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::NOTICE => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::WARNING => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::ERROR => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::CRITICAL => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::ALERT => 0, \ShopMagicGoogleSheetsVendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\ShopMagicGoogleSheetsVendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \ShopMagicGoogleSheetsVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
