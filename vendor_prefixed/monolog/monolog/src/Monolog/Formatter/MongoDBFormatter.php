 ...
 */
class MongoDBFormatter implements \ShopMagicGoogleSheetsVendor\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \ShopMagicGoogleSheetsVendor\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \ShopMagicGoogleSheetsVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
