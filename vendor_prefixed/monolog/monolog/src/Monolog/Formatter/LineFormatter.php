 ...
 */
class LineFormatter extends \ShopMagicGoogleSheetsVendor\Monolog\Formatter\NormalizerFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (\false !== \strpos($output, '%')) {
            ...
            if (null === $output) {
                ...
                throw new \RuntimeException('Failed to run preg_replace: ' . $pcreErrorCode . ' / ' . \ShopMagicGoogleSheetsVendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
            }
        }
        return $output;
    }
    ...
    {
        $str = '[object] (' . \ShopMagicGoogleSheetsVendor\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
